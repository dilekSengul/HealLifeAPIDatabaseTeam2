...
#BURADA HATA VERIYOR
  ...
  "You do not have authorization or token error.".
   ...
   When The api user sends a GET request, saves the returned response, and verifies that the status code is '403' with the reason phrase Forbidden.
    When The api user sends a GET request, saves the returned response, and verifies that the status code is '403' with the "message" phrase "You do not have authorization or token error"
